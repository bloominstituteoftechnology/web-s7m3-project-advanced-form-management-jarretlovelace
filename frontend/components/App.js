...
useEffect(() => {
  ...
  const onSubmit = (evt) => {
    evt.preventDefault()
    axios.post('http://webapis.bloomtechdev.com/registration', values)
    .then(res => {
  ...
  return (
    <div>
      ...
      <form onSubmit={onSubmit}>
        {serverSuccess && <h4 className="success">{serverFailure}</h4>}
...
<div classname="inputGroup">
  ...
  {errors.agreement && <div className="validaton">{errors.agreement}</div>}
  </div>
